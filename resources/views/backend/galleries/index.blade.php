    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div id="table">
                    @include('backend.galleries.partial')
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">افزودن تصاویر جدید</h5>
                ...
                <form action="{{ route('gallery.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="fv-row">
                        <label class="fs-6 fw-bold form-label mt-3">
                            <span class="required">عنوان تصویر</span>
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="عنوان تصویر (اجباری)"></i>
                        </label>
                    ...
                    <div class="fv-row">
                        <label class="fs-6 fw-bold form-label mt-3">
                            ...
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="تصویر (اجباری)"></i>
                        </label>
...
<div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">ویرایش تصویر
...
@endsection
@section('script')
<script src="{{ asset('asset/back/metronic/js/customize/gallery.js') }}"></script>
<script>
    let token = "{{ csrf_token() }}";
    let base_path = "{{ asset('image/gallery/') }}";
    let search_url = "{{ route('gallery.search') }}";
    main_id = 14 , sub_id= -1;

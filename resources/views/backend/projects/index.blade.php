    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div id="table">
                    @include('backend.projects.partial')
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('project.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="fv-row">
                        <label class="fs-6 fw-bold form-label mt-3">
                            ...
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="عنوان پروژه (اجباری)"></i>
                        </label>
...
@endsection
@section('script')
<script src="{{ asset('asset/back/metronic/js/customize/projects.js') }}"></script>
<script>
    let token = "{{ csrf_token() }}";
    let base_path = "{{ asset('image/projects/') }}";
    let search_url = "{{ route('project.search') }}";
    main_id = 17, sub_id = -1;

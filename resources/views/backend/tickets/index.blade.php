    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('ticket.create') }}">
                        <button type="button" class="btn btn-primary">افزودن تیکت جدید</button>
                    </a>
            ...
            <div class="card-body pt-0">
                <div id="table">
                    @include('backend.tickets.partial')
                </div>
            </div>
        </div>
    </div>
...
@endsection
@section('script')
<script src="{{ asset('asset/back/metronic/js/customize/tickets.js') }}"></script>
<script>
    let token = "{{ csrf_token() }}";
    let search_url = "{{ route('ticket.search') }}";
    main_id = 10, sub_id = 0;

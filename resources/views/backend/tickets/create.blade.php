...
<div class="container">
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            ...
            @endif
            <form id="mainForm" class="form" method="post" action="{{route('ticket.store')}}" enctype="multipart/form-data">
                @csrf
...
<script src="{{ asset('asset/back/metronic/js/customize/validate/ticket.create.js') }}"></script>

    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        <div class="card-header pt-7" id="kt_chat_contacts_header">
            <div class="card-title">
                ...
                <!--end::Svg Icon-->
                <h2>افزودن اخبار / رویداد جدید</h2>
            </div>
        </div>
        <div class="card-body pt-5">
            ...
            @endif
            <form id="mainForm" class="form" method="post" action="{{route('event.store')}}" enctype="multipart/form-data">
                @csrf
                <div id="user_create_inputs">
                    <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control form-control-solid" name="event_date" id="event_date" />
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <textarea class="form-control form-control-solid" name="body" id="body" rows="5"></textarea>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">

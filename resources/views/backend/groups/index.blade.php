                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <a href="{{route('group.create')}}">
                            <button type="button" class="btn btn-primary">افزودن گروه</button>
                        </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-center text-gray-400 fw-bolder fs-7 gs-0">
                            ...
                            <th class="min-w-125px">نام گروه</th>
                            <th class="min-w-125px">نوع</th>
                            <th class="min-w-125px">شناسه گروه</th>
                            <th class="min-w-125px">تاریخ ایجاد</th>
                            <th class="min-w-125px">تعداد کاربران</th>
                    ...
                    <tbody class="fw-bold text-gray-600 text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="text-gray-800 text-hover-primary mb-1">{{$item->unique_name}}</span>
                            </td>
                            <td>
                                <span class="text-gray-600 text-hover-primary mb-1">{{$item->created_at()}}</span>
                            </td>
                            <td>
                                <span class="text-gray-600 text-hover-primary mb-1">{{$item->members->count()}}</span>
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{route('group.members' , $item->id)}}" class="menu-link px-3">اعضا</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{route('group.edit' , $item->id)}}" class="menu-link px-3" data-kt-customer-table-filter="delete_row">ویرایش</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3 delete_group" data-link="{{route('group.destroy' , $item->unique_name)}}" data-name="{{$item->title}}" data-id="{{$item->id}}">
...
<script>
    ...
    $('.delete_group').click(function() {
        ...
        Swal.fire({
            html: `آیا از حذف گروه <span class="badge badge-primary">${name}</span> مطمئن هستید ؟`
            , icon: "question"
            , buttonsStyling: false
            , showCancelButton: true
    ...
    function deleteGroup(element) {
        $.ajax({
            ...
            , data: {
                'unique_name': element.attr('data-id')
                , '_method': 'DELETE'
            }

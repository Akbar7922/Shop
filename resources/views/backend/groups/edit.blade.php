...
<div class="container">
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            ...
            @endif
            <!--begin::Form-->
            <form id="addGroupForm" class="form" method="post" action="{{route('group.update' , $group->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" name="title" id="title" value="{{ old('title' , $group->title) }}" />
                                <!--end::Input-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-solid" name="unique_name" id="unique_name" value="{{ old('unique_name' , $group->unique_name) }}"/>
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <!--begin::Input-->
                                <textarea class="form-control form-control-solid" name="description" id="description">{{ $group->description }}</textarea>
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Input group-->
...
<script>
    ...
    $(document).ready(function(){
        $('#type').val("{{ old('isGroup' , $group->isGroup) }}").change();
    });
</script>

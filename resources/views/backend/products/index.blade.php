    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input id="search_input" type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-500px ps-15" placeholder="نام یا بارکد محصول را جستجو کنید ..." />
                    </div>
                    <!--end::جستجو-->
                </div>
                <!--begin::Card title-->
            ...
            <div class="card-body pt-0">
                <div id="table">
                    @include('backend.products.partial')
                </div>
            </div>
            <!--end::Card body-->
        </div>
...
@endsection
@section('script')
<script src="{{ asset('asset/back/metronic/js/customize/products.js') }}"></script>
<script>
    let token = "{{csrf_token()}}";
    let search_url = "{{ route('products.search') }}";
    main_id = 5 , sub_id=1;

    ...
    <div class="container">
        ...
        <div class="card card-flush h-lg-100" >
            ...
            <div class="card-body pt-5">
                ...
                <!--begin::Form-->
                <form id="addProductForm" class="form" method="post" action="{{route('product.update' , $product->id)}}">
                    @csrf
                    @method('PATCH')
                    <div id="user_create_inputs" >
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="fs-6 fw-bold form-label mt-3">
                                        <span>نام لاتین</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                           title="نام لاتین محصول (اختیاری)"></i>
                                    </label>
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="en_name" value="{{$product->en_name}}"/>
                                    <!--end::Input-->
                                    {{--                                    <div class="fv-plugins-message-container invalid-feedback"></div>--}}
                                </div>
                                <!--end::Input group-->
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <label
                                                ...
                                                data-kt-image-input-action="change" data-bs-toggle="tooltip" title="تعویض تصویر">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button id="btn_addProduct" type="button" data-kt-contacts-type="submit"

<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
    ...
    <tbody class="fw-bold text-gray-600 text-center">
        ...
        <tr data-item="{{ $item }}">
            ...
            <td>
                <span class="text-gray-800 text-hover-primary mb-1">{{ $item->city->parent->name }}</span>
            </td>
            <td>
            ...
            <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                    <div class="menu-item px-3 edit_item" data-link="{{ route('job.update' , $item->id) }}">
                        <span class="menu-link px-3">ویرایش</span>
                    </div>
                    <a href="{{ route('condition.index' , $item->id) }}">
                        <div class="menu-item px-3">
                            <span class="menu-link px-3">شرایط کاری</span>
                        </div>
                    </a>
                    <div class="menu-item px-3 delete_item" data-link="{{ route('job.destroy', $item->id) }}" data-name="{{ $item->name }}">

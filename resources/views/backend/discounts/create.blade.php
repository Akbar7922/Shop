...
<div class="container">
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            ...
            <!--begin::Form-->
            <form id="addDiscountForm" class="form" method="post" action="{{ route('discount.store') }}">
                @csrf
                ...
                <div id="user_create_inputs">
                    <div class="row row-cols-1 row-cols-sm-4 rol-cols-md-1 row-cols-lg-4">
                        <!--begin::Col-->
                        <div class="col-3 entity" style="opacity: 100%;">
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Tags-->
                                <label class="fs-6 fw-bold form-label mt-3">
                                    <input type="radio" name="entity" id="check" value="0" checked>
                                    <span>فروشگاه</span>
                                </label>
                                <!--end::Tags-->
                                <!--begin::Input-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        <div class="col for" style="opacity: 100%;">
                            <div class="fv-row mb-7">
                                <!--begin::Tags-->
                                <label class="fs-6 fw-bold form-label mt-3">
                                    <input type="radio" name="for" id="for" checked value="0">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-solid" id="code" name="code" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="{{ old('code') }}">
                    ...
                    <div class="row row-cols-1 row-cols-sm-4 rol-cols-md-1 row-cols-lg-4">
                        ...
                        <div class="col-3">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <span class="form-control form-control-solid" id="start_date">{{ old('end_date' , " " ) }}&nbsp;</span>
                        ...
                        <div class="col-3">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <input type="time" class="form-control form-control-solid" name="start_time" id="start_time" value="{{ old('start_time' , '00:00') }}" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <span class="form-control form-control-solid" id="end_date">{{ old('end_date' , " " ) }}&nbsp;</span>
                        ...
                        <div class="col-3">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <input class="form-control form-control-solid" id="end_time" name="end_time" type="time" value="{{ old('end_time' , '00:00') }}" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                    ...
                    <!--end::Separator-->
                    <input type="hidden" name="input_start_date" value="{{ old('start_date') }}">
                    <input type="hidden" name="input_end_date" value="{{ old('end_date') }}">

    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('advertising.create') }}">
                        <button type="button" class="btn btn-primary">افزودن بنر تبلیغاتی جدید</button>
                    </a>
            ...
            <div class="card-body pt-0">
                <div id="table">
                    @include('backend.advertisings.partial')
                </div>
            </div>
        </div>
    </div>
...
@endsection
@section('script')
<script src="{{ asset('asset/back/metronic/js/customize/advertising.js') }}"></script>

<script>
    main_id = 0; sub_id = 1;
    let token = "{{ csrf_token() }}";
    let search_url = "{{ route('advertisings.search') }}";

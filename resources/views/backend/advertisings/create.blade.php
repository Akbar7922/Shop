    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        <div class="card-header pt-7" id="kt_chat_contacts_header">
            <div class="card-title">
                ...
                <!--end::Svg Icon-->
                <h2>افزودن بنر تبلیغاتی جدید</h2>
            </div>
        </div>
        <div class="card-body pt-5">
            ...
            @endif
            <form id="mainForm" class="form" method="post" action="{{route('advertising.store')}}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" name="link" id="link" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row row-cols-2 row-cols-sm-4 rol-cols-md-2 row-cols-lg-4">
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" name="start_date" id="start_date" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" name="end_date" id="end_date" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
...
<script>main_id = 0; sub_id = 0;</script>
@endsection

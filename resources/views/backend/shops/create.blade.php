...
<div class="container">
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            ...
            <!--begin::Form-->
            <form id="addShopForm" class="form" method="post" action="{{route('shop.store')}}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="manager_mobile" id="manager_mobile">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Tags-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" name="nationalCode" id="nationalCode" />
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Input group-->
                                ...
                                <div class="w-100">
                                    <div class="form-floating border rounded">
                                        ...
                                        <select id="center_shop_id" class="form-select form-select-solid lh-1 py-3" name="center_shop_id" data-kt-ecommerce-settings-type="select2_flags" data-placeholder="انتخاب دفترمرکزی">
                                            <option value="1">فاقد دفترمرکزی</option>
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="w-100">
                                    <div class="form-floating border rounded">
                                        <!--begin::انتخاب2-->
                                        <textarea class="form-control form-control-solid" name="address" id="address" rows="4"></textarea>
                                        <!--end::انتخاب2-->
                                    </div>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>

...
@section('content')
<!-- Home slider -->
<section id="tool-bg" class="p-0 height-65">
    <div class="slide-1 home-slider">
        @foreach($advertising as $slide)
        <a href="{{$slide->link}}">
            <div>
                <div class="home text-center">
                    <img src="{{asset('image/advertisings/slider/'.$slide->pic)}}" alt="" class="bg-img blur-up lazyload">
                </div>
            </div>
        </a>
        @endforeach
                ...
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>ارسال رایگان در سراسر جهان</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 service-block">
                ...
                <div class="col-lg-3 col-sm-6 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>پیشنهاد ویژه جشنواره آنلاین جدید</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 service-block">
...
<section class="section-b-space tools-grey ratio_square product_list_section">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="title3">
                    <h2 class="title-inner3">محصولات پرطرفدار</h2>
                    <div class="line"></div>
                </div>
...
<section class="section-b-space tools-grey ratio_square product_list_section">
    <div class="container">
        <div class="title3">
            <h2 class="title-inner3">محصولات پرفروش</h2>
            <div class="line"></div>
        </div>
        @livewire('home-products')

        {{-- <div class="tools-product product-5 product-m">
    ...
    <div class="cart-info cart-wrap">
        ...
        @if(Auth::check() && $product->is_inCart)
        <button title="مشاهده سبدخرید" onclick="window.location='{{ route('cart.index') }}';"><i class="fa fa-shopping-basket"></i>
            سبدخرید
        </button>
        @else
        <button title="اضافه کردن به سبد" class="product_add_to_cart" data-id="{{$product->id}}"><i class="ti-shopping-cart"></i>
            اضافه کردن به سبد
        </button>
        @endif
...
<section class="section-b-space tools-brand">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="no-arrow" style="text-align: center">
                    @foreach($brands as $brand)
                    <div class="logo-block" style="display: inline-block;">
                        <a href="{{ route('search', ['brand' => $brand->id]) }}">
                            <img class="img-brands" src="{{asset('image/brands/'.$brand->id . '.png')}}" alt="">
                        </a>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="me-3" src="../assets/images/tools/pro/1.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>نام محصول </h4>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="me-3" src="../assets/images/tools/pro/2.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>نام محصول </h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="me-3" src="../assets/images/tools/pro/3.jpg"></a>
                        <div class="media-body">
                            <a href="#">
                                <h4>نام محصول </h4>
                            </a>
                            <h4><span>1 عدد 290000</span></h4>
                        </div>
                    </div>
                    <div class="close-circle">
                        <a href="#">
            ...
            <ul class="cart_total">
                <li>
                    <div class="total">
                        <h5>جمع کل : <span>299000</span></h5>
                    </div>
                </li>
                <li>
                    <div class="buttons">
                        <a href="cart.html" class="btn btn-solid btn-xs view-cart">دیدن سبد خرید</a>
                        <a href="#" class="btn btn-solid btn-xs checkout">بررسی </a>
                    </div>
                </li>
            </ul>
        </div>

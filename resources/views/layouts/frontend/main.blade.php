...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('image/icons/logo/small.png') }}" type="image/x-icon">
                                ...
                                <div>
                                    <nav id="main-nav">
                                        ...
                                        <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                            ...
                                            <li><a href="{{ route('soon') }}">مقالات</a></li>
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    ...
                                    <li style="text-transform: unset !important;"><i class="fa fa-envelope"></i>ایمیل ما : {{ $config->email }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>

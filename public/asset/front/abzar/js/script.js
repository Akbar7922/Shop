...
// 11.Full slider
// 12.Slick slider
// 13.Header z-index js
// 14.Tab js
// 15.Category page
// 16.Filter sidebar js
// 17.Add to cart
// 18.Add to wishlist
// 19.Dark Light
// 20.Menu
// 21.Tooltip
// 22.Cookiebar
// 23.Recently puchase modal
// 24.other js
// 25.Add to cart quantity Counter
...
(function ($) {
    ...
    $(function () {
        ...
        $(".loadMore").on('click', function (e) {
            ...
            if ($(".product-load-more .col-grid-box:hidden").length === 0) {
                $(".loadMore").text('محصول بیشتری نیست');
            }
        });
    });
        ...
        $(".load-product").on('click', function (e) {
            ...
            t = setTimeout(function () {
                ...
                if ($(".infinite-product .product-box:hidden").length === 0) {
                    $(".load-product").text('محصول بیشتری نیست');
    ...
    $('.product-box button .ti-shopping-cart').on('click', function () {
        $.notify({
            icon: 'fa fa-check',
            title: 'موفقیت!',
            message: 'مورد با موفقیت به سبد خرید اضافه شد'
        }, {
            element: 'body',
            position: null,
            type: "success",
    ...
    /*=====================
     18.Add to wishlist
     ==========================*/
    $('.product-box a .ti-heart').on('click', function () {
...
$('#cartEffect').on('click', function (e) {
    if ($("#selectSize .size-box ul").hasClass('selected')) {
        $('#cartEffect').text("به سبد اضافه شد");
